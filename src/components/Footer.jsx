    ...
    <footer className="relative z-10 mt-16 border-t-neo border-border bg-white">
      <div className="max-w-7xl mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
          ...
          <a href={`mailto:${contactInfo.email}`} className="w-10 h-10 flex items-center justify-center border-neoSm border-border bg-bg shadow-neoSm hover:bg-pink hover:text-white transition-all" aria-label="Email"><FaEnvelope /></a>
        </div>
      </div>
    </footer>
  );
