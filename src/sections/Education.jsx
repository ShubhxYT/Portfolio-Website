  ...
  return (
    <section className="relative z-10 max-w-7xl mx-auto px-4 py-16">
      ...
      <div className="grid sm:grid-cols-2 gap-6">
        {education.map((e) => (
          <div key={e.school} className="p-6 border-neo border-border bg-white shadow-neo hover:shadow-neoLg hover:-translate-y-1 transition-all">
            ...
            <div className="flex flex-wrap gap-1.5 mt-3">
              {e.tags.map((t) => (
                <span key={t} className="px-2 py-0.5 border-neoSm border-border bg-bg font-mono text-xs hover:bg-pink hover:text-white transition-colors">
                  {t}
                </span>
              ))}
            </div>
