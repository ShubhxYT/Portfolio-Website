...
╚══════╝╚═╝  ╚═╝ ╚═════╝ ╚═════╝ ╚═╝  ╚═╝`;
    ...
    const welcome =
      ...
      this.wrapWithColor(
        "         AI Engineer • Full-Stack Developer • Self-Taught\n",
        "#666666"
      ) +
      this.wrapWithColor(divider + "\n\n", "#555555") +
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Self-taught AI engineer and third-year CS student",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
...
${this.wrapWithColor(
  "   RAG systems, computer vision, and full-stack AI apps",
  "#ffffff"
)}
${this.wrapWithColor("   28+ GitHub repos spanning LLM orchestration,", "#ffffff")}
${this.wrapWithColor("   LangGraph, and self-hosted infrastructure", "#ffffff")}

${this.wrapWithColor("⚡ Stack", "#ff8c00")}
${this.wrapWithColor(
  "   Python, TypeScript, PyTorch, LangChain, FastAPI, React",
  "#ffffff"
)}
${this.wrapWithColor(
  "   Docker, PostgreSQL, Proxmox, Coolify, Cloudflare",
  "#ffffff"
)}

${this.wrapWithColor("⚡ Infrastructure", "#ff8c00")}
${this.wrapWithColor(
  "   Homelab running 10+ services across 5 domains",
  "#ffffff"
)}
${this.wrapWithColor(
  "   with zero recurring cost on repurposed hardware",
  "#ffffff"
)}
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "From bare metal to browser — ships real products.",
      "#ffffff"
...
<span style="color: #00ffff;">IEEE Computer Society | Technical Core Team</span>
${this.wrapWithColor(
  "2026 | Manipal University Jaipur",
  "#ffffff"
)}
${this.wrapWithColor(
  "Full-stack RAG hiring platform — 17 modules, 8,500+ lines",
  "#98fb98"
)}

• ${this.wrapWithColor("RAG architect", "#ffa07a")} - ${this.wrapWithColor(
      "Hybrid retrieval fusion (dense vector + BM25 + HyDE) with RRF and cross-encoder re-ranking",
      "#ffffff"
    )}
• ${this.wrapWithColor(
      "Safety system",
      ...
      "Defense-in-depth with 19-pattern regex guardrails, LLM gatekeeper, and LLM auditor — 80%+ attack block rate",
      "#ffffff"
    )}
• ${this.wrapWithColor("Data ingestion", "#ffa07a")} - ${this.wrapWithColor(
      "20+ document format pipeline (PDF, DOCX, PPTX, images) with heading-aware chunking and LLM summaries",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies:", "#00ffff")} ${this.wrapWithColor(
      "Python, LangChain, LangGraph, pgvector, BGE-M3, FastAPI, React, TypeScript",
      "#87cefa"
    )}

<span style="color: #00ffff;">IEEE Computer Society | Technical Junior Team</span>
${this.wrapWithColor(
  "2025 | Manipal University Jaipur",
  "#ffffff"
)}
${this.wrapWithColor(
  "Virtual Mentor — multi-modal RAG learning assistant",
  "#98fb98"
)}

• ${this.wrapWithColor("RAG pipeline", "#ffa07a")} - ${this.wrapWithColor(
      "Multi-modal retrieval across 8 semesters of course materials with curriculum-aware chunking",
      "#ffffff"
    )}
• ${this.wrapWithColor("LLM Q&A", "#ffa07a")} - ${this.wrapWithColor(
      "Cross-semester knowledge linking with precise, context-aware responses from curriculum documents",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies:", "#00ffff")} ${this.wrapWithColor(
      "Python, LLM, Multi-Modal RAG, Embeddings, Vector Search",
      "#87cefa"
    )}

<span style="color: #00ffff;">WhiteHat Jr | Python Development</span>
${this.wrapWithColor(
  "2021 | Delhi, India (Remote)",
  "#ffffff"
)}

• ${this.wrapWithColor("Data analysis", "#ffa07a")} - ${this.wrapWithColor(
      "Built strong foundations in data analysis and visualization using NumPy, Pandas, and Matplotlib",
      "#ffffff"
    )}
• ${this.wrapWithColor("Remote collaboration", "#ffa07a")} - ${this.wrapWithColor(
      "Collaborated on Python-based projects during the pandemic, developing independent problem-solving skills",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies:", "#00ffff")} ${this.wrapWithColor(
      "Python, NumPy, Pandas, Matplotlib, Data Visualization",
      "#87cefa"
    )}`;
...
<span style="color: #00ffff; font-weight: bold;">📜 Certifications</span>

• ${this.wrapWithColor("Microsoft Azure — From Zero to Hero", "#ffffff")}
• ${this.wrapWithColor("Stanford — Unsupervised Learning, Recommenders, Reinforcement Learning", "#ffffff")}
• ${this.wrapWithColor("Stanford — Supervised Machine Learning: Regression and Classification", "#ffffff")}
...
${this.wrapWithColor("│", "#ff8c00")}${this.wrapWithColor(
      " Self-taught AI engineer building from the ground up ",
      "#ffffff"
    )}${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor(
  "╰──────────────────────────────────────────────────╯",
  ...
  showSkills(outputElement = this.output) {
    const skills = `<span style="color: #ffff00; font-weight: bold;">🛠️ LANGUAGES & ML</span>
...
• ${this.wrapWithColor("Bash", "#ffffff")}

<span style="color: #00ffff; font-weight: bold;">🧠 ML / AI</span>

• ${this.wrapWithColor("PyTorch", "#ffffff")}
• ${this.wrapWithColor("LangChain", "#ffffff")}
• ${this.wrapWithColor("LangGraph", "#ffffff")}
• ${this.wrapWithColor("LlamaIndex", "#ffffff")}
• ${this.wrapWithColor("Scikit-Learn", "#ffffff")}
• ${this.wrapWithColor("XGBoost", "#ffffff")}

<span style="color: #ffff00; font-weight: bold;">🔍 RAG & VECTOR</span>

• ${this.wrapWithColor("pgvector", "#ffffff")}
• ${this.wrapWithColor("ChromaDB", "#ffffff")}
• ${this.wrapWithColor("BGE-M3", "#ffffff")}
• ${this.wrapWithColor("BM25", "#ffffff")}
• ${this.wrapWithColor("Cross-Encoders", "#ffffff")}
• ${this.wrapWithColor("HyDE", "#ffffff")}
• ${this.wrapWithColor("RRF Fusion", "#ffffff")}

<span style="color: #00ffff; font-weight: bold;">👁️ COMPUTER VISION</span>

• ${this.wrapWithColor("YOLOv8", "#ffffff")}
• ${this.wrapWithColor("MediaPipe", "#ffffff")}
• ${this.wrapWithColor("OpenCV", "#ffffff")}
• ${this.wrapWithColor("EasyOCR", "#ffffff")}
• ${this.wrapWithColor("SORT Tracking", "#ffffff")}

<span style="color: #ffff00; font-weight: bold;">⚙️ FRAMEWORKS</span>

• ${this.wrapWithColor("FastAPI", "#ffffff")}
• ${this.wrapWithColor("Django", "#ffffff")}
• ${this.wrapWithColor("React", "#ffffff")}
• ${this.wrapWithColor("Next.js", "#ffffff")}
• ${this.wrapWithColor("Streamlit", "#ffffff")}
• ${this.wrapWithColor("Typer", "#ffffff")}

<span style="color: #00ffff; font-weight: bold;">🐳 INFRASTRUCTURE</span>

• ${this.wrapWithColor("Docker", "#ffffff")}
• ${this.wrapWithColor("PostgreSQL", "#ffffff")}
• ${this.wrapWithColor("Nginx", "#ffffff")}
• ${this.wrapWithColor("Proxmox", "#ffffff")}
• ${this.wrapWithColor("Coolify", "#ffffff")}
• ${this.wrapWithColor("Tailscale", "#ffffff")}
• ${this.wrapWithColor("Cloudflare", "#ffffff")}`;
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:shubhsomani098@gmail.com" style="color: #ffffff; text-decoration: none;">shubhsomani098@gmail.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://shubhsomani.tech" target="_blank" style="color: #ffffff; text-decoration: none;">shubhsomani.tech</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/ShubhxYT" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/ShubhxYT</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://linkedin.com/in/shubh-somani" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/shubh-somani</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
    ...
    this.projects = [
      {
        ...
        description: "Multi-service AI content pipeline for a 100k-subscriber creator. Bilingual Hindi-English transcription via Groq Whisper, voice profiling across 9 dimensions, and LangGraph-powered platform-specific content generation (LinkedIn, Twitter).",
        image: "path/to/project-image.jpg",
        technologies: ["Python", "LangGraph", "Groq", "Whisper", "PostgreSQL", "yt-dlp"],
        demo: "https://github.com/ShubhxYT",
        repo: "https://github.com/ShubhxYT",
      },
      {
        title: "FullRag-Plus",
        description: "Enterprise RAG platform (16,200 lines) with FastAPI + React + pgvector. Continuous evaluation with regression detection, dual-provider LLM pipeline (Gemini + Groq), and 3-service Docker Compose deployment.",
        image: "path/to/project-image.jpg",
        technologies: ["Python", "FastAPI", "React", "TypeScript", "PostgreSQL", "pgvector", "Docker"],
        demo: "https://github.com/ShubhxYT",
        repo: "https://github.com/ShubhxYT",
      },
      {
        title: "HappyNest Website",
        description: "Full-stack luxury farmstay site (happynestfarm.in) with GSAP ScrollTrigger video hero, AI chat concierge with SSE streaming, dual-LLM fallback, and CAG approach serving real guests at zero hosting cost.",
        image: "path/to/project-image.jpg",
        technologies: ["Next.js", "TypeScript", "FastAPI", "Supabase", "GSAP", "Docker"],
        demo: "https://happynestfarm.in",
        repo: "https://github.com/ShubhxYT",
      },
      {
        title: "Interactive 3D Portfolio",
        description: "3D portfolio at shubhsomani.tech with Spline 3D character, Rapier physics gravity-ball simulation, GSAP animations, custom cursor with spring physics, and 1,900 lines of hand-crafted CSS.",
        image: "path/to/project-image.jpg",
        technologies: ["React", "TypeScript", "Vite", "Spline", "Rapier", "GSAP"],
        demo: "https://shubhsomani.tech",
        repo: "https://github.com/ShubhxYT",
      },
      {
        title: "Computer Vision Toolkit",
        description: "Multi-module CV toolkit: pose estimation (33 landmarks via MediaPipe BlazePose), license plate recognition (YOLOv8 + SORT + EasyOCR), and object detection/counting with line-cross detection and region masking.",
        image: "path/to/project-image.jpg",
        technologies: ["Python", "YOLOv8", "MediaPipe", "OpenCV", "EasyOCR", "SORT"],
        demo: "https://github.com/ShubhxYT",
        repo: "https://github.com/ShubhxYT",
      },
    ];
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "shubh@somani: ~/interactive-resume";
...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝ ╚═════╝ `;
    ...
    url.textContent = "shubhsomani.tech";
